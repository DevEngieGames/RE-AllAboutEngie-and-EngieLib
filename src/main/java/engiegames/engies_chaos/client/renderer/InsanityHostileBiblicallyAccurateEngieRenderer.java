...
public class InsanityHostileBiblicallyAccurateEngieRenderer extends MobRenderer<InsanityHostileBiblicallyAccurateEngieEntity, Modelinsanityhostile<InsanityHostileBiblicallyAccurateEngieEntity>> {
	public InsanityHostileBiblicallyAccurateEngieRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelinsanityhostile<InsanityHostileBiblicallyAccurateEngieEntity>(context.bakeLayer(Modelinsanityhostile.LAYER_LOCATION)), 0.5f);
	}

	@Override
	protected void scale(InsanityHostileBiblicallyAccurateEngieEntity entity, PoseStack poseStack, float f) {
