...
public class SharkoOnEntityTickUpdateProcedure {
		...
		if (!world.isClientSide()) {
			if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof SharkoEntity _datEntI ? _datEntI.getEntityData().get(SharkoEntity.DATA_SharkoState) : 0) != 0) {
				...
				if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC) == true) {
					if ((entity instanceof SharkoEntity _datEntI ? _datEntI.getEntityData().get(SharkoEntity.DATA_SharkoState) : 0) == 4) {
					...
					if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC) == true) {
						...
						if (!entity.isInWater() && !entity.isInLava()) {
							if ((entity instanceof SharkoEntity _datEntI ? _datEntI.getEntityData().get(SharkoEntity.DATA_SharkoState) : 0) == 1) {
								if (Math.random() <= 0.5) {
									if (entity instanceof SharkoEntity _datEntSetI)
										_datEntSetI.getEntityData().set(SharkoEntity.DATA_SharkoState, 2);
									if (Math.random() <= 0.49) {
										if (entity instanceof SharkoEntity _datEntSetL)
											_datEntSetL.getEntityData().set(SharkoEntity.DATA_AlternateState, false);
									} else {
										if (entity instanceof SharkoEntity _datEntSetL)
											_datEntSetL.getEntityData().set(SharkoEntity.DATA_AlternateState, true);
									}
								}
							} else if ((entity instanceof SharkoEntity _datEntI ? _datEntI.getEntityData().get(SharkoEntity.DATA_SharkoState) : 0) == 2) {
								if (Math.random() <= 0.5) {
									if (Math.random() <= 0.49) {
										if (entity instanceof SharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(SharkoEntity.DATA_SharkoState, 3);
										...
										if (Math.random() >= 0.75) {
											if (entity instanceof SharkoEntity _datEntSetI)
												_datEntSetI.getEntityData().set(SharkoEntity.DATA_SharkoState, 1);
										}
									}
								}
							} else if ((entity instanceof SharkoEntity _datEntI ? _datEntI.getEntityData().get(SharkoEntity.DATA_SharkoState) : 0) == 3) {
								if (Math.random() >= 0.75) {
									if (entity instanceof SharkoEntity _datEntSetI)
										_datEntSetI.getEntityData().set(SharkoEntity.DATA_SharkoState, 2);
									if (Math.random() <= 0.49) {
							...
							if (!entity.isInWater() && !entity.isInLava()) {
								if ((entity instanceof SharkoEntity _datEntI ? _datEntI.getEntityData().get(SharkoEntity.DATA_SharkoState) : 0) == 1) {
									...
									if (Math.random() <= 0.0625) {
										if (entity instanceof SharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(SharkoEntity.DATA_SharkoState, 4);
										if (Math.random() <= 0.49) {
											if (entity instanceof SharkoEntity _datEntSetL)
												_datEntSetL.getEntityData().set(SharkoEntity.DATA_AlternateState, false);
										} else {
								...
								} else if ((entity instanceof SharkoEntity _datEntI ? _datEntI.getEntityData().get(SharkoEntity.DATA_SharkoState) : 0) == 4) {
									if (Math.random() <= 0.5) {
										if (entity instanceof SharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(SharkoEntity.DATA_SharkoState, 3);
									}
			...
			if (EngiesChaosModVariables.MapVariables.get(world).difficultytoggle == true) {
				if (EngiesChaosModVariables.MapVariables.get(world).MobDifficulty > 0) {
					if (entity instanceof LivingEntity _livingEntity61 && _livingEntity61.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
						_livingEntity61.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue((5 * 2.5 * EngiesChaosModVariables.MapVariables.get(world).MobDifficulty));
				}
			}
		}
	}
