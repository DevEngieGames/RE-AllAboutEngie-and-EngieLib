...
public class GlitchSharkoOnEntityTickUpdateProcedure {
				...
				if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC) == true) {
					if ((entity instanceof GlitchSharkoEntity _datEntI ? _datEntI.getEntityData().get(GlitchSharkoEntity.DATA_SharkoState) : 0) == 4) {
						if (entity instanceof GlitchSharkoEntity _datEntSetI)
							_datEntSetI.getEntityData().set(GlitchSharkoEntity.DATA_SharkoState, 3);
					}
				}
				if (entity.getPersistentData().getDouble("SharkoStateTimerForChance") <= 0) {
					if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC) == true) {
						...
						if (!entity.isInWater() && !entity.isInLava()) {
							if ((entity instanceof GlitchSharkoEntity _datEntI ? _datEntI.getEntityData().get(GlitchSharkoEntity.DATA_SharkoState) : 0) == 1) {
								if (Math.random() <= 0.5) {
									if (entity instanceof GlitchSharkoEntity _datEntSetI)
										_datEntSetI.getEntityData().set(GlitchSharkoEntity.DATA_SharkoState, 2);
									if (Math.random() <= 0.49) {
										if (entity instanceof GlitchSharkoEntity _datEntSetL)
											_datEntSetL.getEntityData().set(GlitchSharkoEntity.DATA_AlternateState, false);
									} else {
										if (entity instanceof GlitchSharkoEntity _datEntSetL)
											_datEntSetL.getEntityData().set(GlitchSharkoEntity.DATA_AlternateState, true);
									}
								}
							} else if ((entity instanceof GlitchSharkoEntity _datEntI ? _datEntI.getEntityData().get(GlitchSharkoEntity.DATA_SharkoState) : 0) == 2) {
								if (Math.random() <= 0.5) {
									if (Math.random() <= 0.49) {
										if (entity instanceof GlitchSharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(GlitchSharkoEntity.DATA_SharkoState, 3);
							...
							} else if ((entity instanceof GlitchSharkoEntity _datEntI ? _datEntI.getEntityData().get(GlitchSharkoEntity.DATA_SharkoState) : 0) == 3) {
								if (Math.random() >= 0.75) {
									if (entity instanceof GlitchSharkoEntity _datEntSetI)
										_datEntSetI.getEntityData().set(GlitchSharkoEntity.DATA_SharkoState, 2);
									if (Math.random() <= 0.49) {
							...
							if (!entity.isInWater() && !entity.isInLava()) {
								if ((entity instanceof GlitchSharkoEntity _datEntI ? _datEntI.getEntityData().get(GlitchSharkoEntity.DATA_SharkoState) : 0) == 1) {
									...
									if (Math.random() <= 0.0625) {
										if (entity instanceof GlitchSharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(GlitchSharkoEntity.DATA_SharkoState, 4);
										if (Math.random() <= 0.49) {
											if (entity instanceof GlitchSharkoEntity _datEntSetL)
												_datEntSetL.getEntityData().set(GlitchSharkoEntity.DATA_AlternateState, false);
										} else {
								...
								} else if ((entity instanceof GlitchSharkoEntity _datEntI ? _datEntI.getEntityData().get(GlitchSharkoEntity.DATA_SharkoState) : 0) == 4) {
									if (Math.random() <= 0.5) {
										if (entity instanceof GlitchSharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(GlitchSharkoEntity.DATA_SharkoState, 3);
									}
