...
public class UncommonSharkoOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!world.isClientSide()) {
			if ((entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) && (entity instanceof UncommonSharkoEntity _datEntI ? _datEntI.getEntityData().get(UncommonSharkoEntity.DATA_SharkoState) : 0) != 0) {
				...
				if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC) == true) {
					if ((entity instanceof UncommonSharkoEntity _datEntI ? _datEntI.getEntityData().get(UncommonSharkoEntity.DATA_SharkoState) : 0) == 4) {
						...
						if (!entity.isInWater() && !entity.isInLava()) {
							if ((entity instanceof UncommonSharkoEntity _datEntI ? _datEntI.getEntityData().get(UncommonSharkoEntity.DATA_SharkoState) : 0) == 1) {
								if (Math.random() <= 0.5) {
									...
									if (Math.random() <= 0.49) {
										if (entity instanceof UncommonSharkoEntity _datEntSetL)
											_datEntSetL.getEntityData().set(UncommonSharkoEntity.DATA_AlternateState, false);
									} else {
										if (entity instanceof UncommonSharkoEntity _datEntSetL)
							...
							if (!entity.isInWater() && !entity.isInLava()) {
								if ((entity instanceof UncommonSharkoEntity _datEntI ? _datEntI.getEntityData().get(UncommonSharkoEntity.DATA_SharkoState) : 0) == 1) {
									...
									if (Math.random() <= 0.0625) {
										if (entity instanceof UncommonSharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(UncommonSharkoEntity.DATA_SharkoState, 4);
										if (Math.random() <= 0.49) {
											if (entity instanceof UncommonSharkoEntity _datEntSetL)
												_datEntSetL.getEntityData().set(UncommonSharkoEntity.DATA_AlternateState, false);
										} else {
			...
			if (EngiesChaosModVariables.MapVariables.get(world).difficultytoggle == true) {
				if (EngiesChaosModVariables.MapVariables.get(world).MobDifficulty > 0) {
					if (entity instanceof LivingEntity _livingEntity61 && _livingEntity61.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
						_livingEntity61.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue((10 * 2.5 * EngiesChaosModVariables.MapVariables.get(world).MobDifficulty));
				}
			}
		}
	}
