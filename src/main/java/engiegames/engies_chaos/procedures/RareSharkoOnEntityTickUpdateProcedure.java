					...
					if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC) == true) {
						...
						if (world instanceof Level _lvl25 && _lvl25.isDay()) {
							...
							if (!entity.isInWater() && !entity.isInLava()) {
								...
								} else if ((entity instanceof RareSharkoEntity _datEntI ? _datEntI.getEntityData().get(RareSharkoEntity.DATA_SharkoState) : 0) == 2) {
									if (Math.random() <= 0.5) {
										if (Math.random() <= 0.49) {
											if (entity instanceof RareSharkoEntity _datEntSetI)
												_datEntSetI.getEntityData().set(RareSharkoEntity.DATA_SharkoState, 3);
								...
								} else if ((entity instanceof RareSharkoEntity _datEntI ? _datEntI.getEntityData().get(RareSharkoEntity.DATA_SharkoState) : 0) == 3) {
								...
								} else if ((entity instanceof RareSharkoEntity _datEntI ? _datEntI.getEntityData().get(RareSharkoEntity.DATA_SharkoState) : 0) == 4) {
									if (Math.random() <= 0.5) {
										if (entity instanceof RareSharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(RareSharkoEntity.DATA_SharkoState, 3);
									}
			...
			if (EngiesChaosModVariables.MapVariables.get(world).difficultytoggle == true) {
				if (EngiesChaosModVariables.MapVariables.get(world).MobDifficulty > 0) {
					if (entity instanceof LivingEntity _livingEntity61 && _livingEntity61.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
						_livingEntity61.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue((15 * 2.5 * EngiesChaosModVariables.MapVariables.get(world).MobDifficulty));
				}
			}
		}
	}
