				...
				if (entity.getPersistentData().getDouble("SharkoStateTimerForChance") <= 0) {
					if (world.getLevelData().getGameRules().getBoolean(EngiesChaosModGameRules.ENGIE_POC) == true) {
						...
						if (!entity.isInWater() && !entity.isInLava()) {
							...
							} else if ((entity instanceof TigerSharkoEntity _datEntI ? _datEntI.getEntityData().get(TigerSharkoEntity.DATA_SharkoState) : 0) == 2) {
								if (Math.random() <= 0.5) {
									if (Math.random() <= 0.49) {
										if (entity instanceof TigerSharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(TigerSharkoEntity.DATA_SharkoState, 3);
							...
							} else if ((entity instanceof TigerSharkoEntity _datEntI ? _datEntI.getEntityData().get(TigerSharkoEntity.DATA_SharkoState) : 0) == 3) {
								if (Math.random() >= 0.75) {
									if (entity instanceof TigerSharkoEntity _datEntSetI)
										_datEntSetI.getEntityData().set(TigerSharkoEntity.DATA_SharkoState, 2);
									if (Math.random() <= 0.49) {
						...
						if (world instanceof Level _lvl25 && _lvl25.isDay()) {
							...
							if (!entity.isInWater() && !entity.isInLava()) {
								...
								} else if ((entity instanceof TigerSharkoEntity _datEntI ? _datEntI.getEntityData().get(TigerSharkoEntity.DATA_SharkoState) : 0) == 4) {
									if (Math.random() <= 0.5) {
										if (entity instanceof TigerSharkoEntity _datEntSetI)
											_datEntSetI.getEntityData().set(TigerSharkoEntity.DATA_SharkoState, 3);
									}
			...
			if (EngiesChaosModVariables.MapVariables.get(world).difficultytoggle == true) {
				if (EngiesChaosModVariables.MapVariables.get(world).MobDifficulty > 0) {
					if (entity instanceof LivingEntity _livingEntity61 && _livingEntity61.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
						_livingEntity61.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue((50 * 2.5 * EngiesChaosModVariables.MapVariables.get(world).MobDifficulty));
				}
			}
		}
	}
