	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = NightmareEngieEntity.this.getX();
				double y = NightmareEngieEntity.this.getY();
				double z = NightmareEngieEntity.this.getZ();
				Entity entity = NightmareEngieEntity.this;
				Level world = NightmareEngieEntity.this.level;
