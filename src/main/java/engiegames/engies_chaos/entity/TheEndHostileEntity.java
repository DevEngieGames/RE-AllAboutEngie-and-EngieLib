...
public class TheEndHostileEntity extends Monster {
	public TheEndHostileEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.THE_END_HOSTILE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.THE_END_HOSTILE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
