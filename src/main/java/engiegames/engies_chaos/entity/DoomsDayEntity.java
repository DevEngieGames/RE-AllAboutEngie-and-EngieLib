...
public class DoomsDayEntity extends PathfinderMob {
	public DoomsDayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.DOOMS_DAY.get(), world);
	}
	...
	public DoomsDayEntity(EntityType<DoomsDayEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(EngiesChaosModItems.DOOMS_DAY_CRUCIFIX.get()));
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		DoomsDayRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.DOOMS_DAY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
