...
public class EngieGamesMonstrosityEngieEntity extends Monster {
	public EngieGamesMonstrosityEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_GAMES_MONSTROSITY_ENGIE.get(), world);
	}

	public EngieGamesMonstrosityEngieEntity(EntityType<EngieGamesMonstrosityEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 55;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				...
				double y = EngieGamesMonstrosityEngieEntity.this.getY();
				double z = EngieGamesMonstrosityEngieEntity.this.getZ();
				Entity entity = EngieGamesMonstrosityEngieEntity.this;
				Level world = EngieGamesMonstrosityEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_GAMES_MONSTROSITY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
