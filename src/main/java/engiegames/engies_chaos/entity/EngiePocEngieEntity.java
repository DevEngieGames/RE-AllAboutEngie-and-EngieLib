	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngiePocEngieEntity.this.getX();
				double y = EngiePocEngieEntity.this.getY();
				double z = EngiePocEngieEntity.this.getZ();
				Entity entity = EngiePocEngieEntity.this;
				Level world = EngiePocEngieEntity.this.level;
