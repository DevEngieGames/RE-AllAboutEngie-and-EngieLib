...
public class EngieGamesHostileBiblicallyAccurateEngieEntity extends Monster {
	public EngieGamesHostileBiblicallyAccurateEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_GAMES_HOSTILE_BIBLICALLY_ACCURATE_ENGIE.get(), world);
	}

	public EngieGamesHostileBiblicallyAccurateEngieEntity(EntityType<EngieGamesHostileBiblicallyAccurateEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 45;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngieGamesHostileBiblicallyAccurateEngieEntity.this.getX();
				double y = EngieGamesHostileBiblicallyAccurateEngieEntity.this.getY();
				double z = EngieGamesHostileBiblicallyAccurateEngieEntity.this.getZ();
				Entity entity = EngieGamesHostileBiblicallyAccurateEngieEntity.this;
				Level world = EngieGamesHostileBiblicallyAccurateEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_GAMES_HOSTILE_BIBLICALLY_ACCURATE_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
