...
public class EngieGamesAngryEngieEntity extends Monster {
	public EngieGamesAngryEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_GAMES_ANGRY_ENGIE.get(), world);
	}

	public EngieGamesAngryEngieEntity(EntityType<EngieGamesAngryEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 15;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngieGamesAngryEngieEntity.this.getX();
				double y = EngieGamesAngryEngieEntity.this.getY();
				double z = EngieGamesAngryEngieEntity.this.getZ();
				Entity entity = EngieGamesAngryEngieEntity.this;
				Level world = EngieGamesAngryEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_GAMES_ANGRY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
