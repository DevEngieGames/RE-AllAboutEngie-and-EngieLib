...
import engiegames.engies_chaos.procedures.SuperDoomsDayHostileEntityDiesProcedure;
import engiegames.engies_chaos.procedures.NegativeDifficultyAICheckProcedure;
import engiegames.engies_chaos.procedures.HostileSuperDoomsdayEntitySpawningConditionProcedure;
...
public class SuperDoomsDayHostileEntity extends Monster {
	public SuperDoomsDayHostileEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.SUPER_DOOMS_DAY_HOSTILE.get(), world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 2.85, false) {
			@Override
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = SuperDoomsDayHostileEntity.this.getX();
				double y = SuperDoomsDayHostileEntity.this.getY();
				double z = SuperDoomsDayHostileEntity.this.getZ();
				Entity entity = SuperDoomsDayHostileEntity.this;
				Level world = SuperDoomsDayHostileEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.SUPER_DOOMS_DAY_HOSTILE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return HostileSuperDoomsdayEntitySpawningConditionProcedure.execute(world, x, y, z);
		});
	}
