	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = InsanityEngieEntity.this.getX();
				double y = InsanityEngieEntity.this.getY();
				double z = InsanityEngieEntity.this.getZ();
				Entity entity = InsanityEngieEntity.this;
				Level world = InsanityEngieEntity.this.level;
