...
public class EngieGamesEnragedEngieEntity extends Monster {
	public EngieGamesEnragedEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EngiesChaosModEntities.ENGIE_GAMES_ENRAGED_ENGIE.get(), world);
	}

	public EngieGamesEnragedEngieEntity(EntityType<EngieGamesEnragedEngieEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 25;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, true, false) {
			...
			public boolean canUse() {
				double x = EngieGamesEnragedEngieEntity.this.getX();
				double y = EngieGamesEnragedEngieEntity.this.getY();
				double z = EngieGamesEnragedEngieEntity.this.getZ();
				Entity entity = EngieGamesEnragedEngieEntity.this;
				Level world = EngieGamesEnragedEngieEntity.this.level;
	...
	public static void init() {
		SpawnPlacements.register(EngiesChaosModEntities.ENGIE_GAMES_ENRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
